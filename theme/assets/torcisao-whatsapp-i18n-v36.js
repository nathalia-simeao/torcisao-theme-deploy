...
const p=product();
const HASTE_UNIFIED_FORM='8fdff701-c5a7-4684-9358-d557a70425a5';
function lockUnifiedHasteForm(){
 if(p!=='haste'||!window.TORCISAO_HASTE_PAGE)return;
 const cfg=window.TORCISAO_HASTE_PAGE;
 cfg.portalId='50818463';
 cfg.formId=HASTE_UNIFIED_FORM;
 cfg.formIds={baixa:HASTE_UNIFIED_FORM,alta:HASTE_UNIFIED_FORM,conectores:HASTE_UNIFIED_FORM};
}
const copy={
