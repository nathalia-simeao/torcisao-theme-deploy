...
<main class="th-home" id="home">
  ...
  <section class="th-section th-products" id="produtos">
    <div class="th-container">
      ...
      <div class="tpe-line-menu" role="tablist" aria-label="Selecione a linha Torcisão">
        ...
        <button type="button" class="tpe-line-tab" data-tpe-line="barra" role="tab" aria-selected="false">Barra</button>
        <button type="button" class="tpe-line-tab" data-tpe-line="haste" role="tab" aria-selected="false">Haste</button>
        <button type="button" class="tpe-line-tab" data-tpe-line="conectores" role="tab" aria-selected="false">Conectores</button>
      </div>
      <div class="tpe-shell" id="tpeShell">
        <aside class="tpe-options" aria-label="Opções da linha selecionada">
          <div class="tpe-options-head"><small>OPÇÕES</small><strong id="tpeOptionsTitle">Arame</strong></div>
          <div id="tpeOptionGroups">
            <div class="tpe-option-group"><small>Linha</small><div class="tpe-option-list">
              <button type="button" class="tpe-option is-active" data-tpe-key="variant" data-tpe-value="btc">BTC · Baixo Carbono</button>
              <button type="button" class="tpe-option" data-tpe-key="variant" data-tpe-value="mtc">MTC · Médio Carbono</button>
              <button type="button" class="tpe-option" data-tpe-key="variant" data-tpe-value="atc">ATC · Alto Carbono</button>
            </div></div>
            <div class="tpe-option-group"><small>Visualização</small><div class="tpe-option-list">
              <button type="button" class="tpe-option" data-tpe-key="view" data-tpe-value="rolo">Rolo</button>
              <button type="button" class="tpe-option is-active" data-tpe-key="view" data-tpe-value="spider">Spider</button>
            </div></div>
          </div>
        </aside>
        <div class="tpe-stage" id="tpeStage" data-line="arame">
          <div class="tpe-stage-toolbar">
            <span><i class="bi bi-search"></i> Passe o cursor para ampliar</span>
            <div>
              <button type="button" id="tpeZoomOut" aria-label="Diminuir zoom">−</button>
              <span id="tpeZoomLabel">1,0×</span>
              <button type="button" id="tpeZoomIn" aria-label="Aumentar zoom">+</button>
              <button type="button" id="tpeReset" aria-label="Redefinir"><i class="bi bi-arrow-counterclockwise"></i></button>
            </div>
          </div>
          <div class="tpe-image-wrap" id="tpeImageWrap" tabindex="0" role="button" aria-label="Abrir imagem ampliada">
            <img id="tpeImage"
                 src="https://torcisao.com.br/wp-content/uploads/2026/09/arametrefiladospider-300x300.png"
                 srcset="https://torcisao.com.br/wp-content/uploads/2026/09/arametrefiladospider-300x300.png 300w, https://torcisao.com.br/wp-content/uploads/2026/09/arametrefiladospider-768x768.png 768w"
                 sizes="(max-width: 767px) 300px, 768px"
                 width="768" height="768"
                 alt="Arame Trefilado · Baixo Carbono"
                 loading="eager" decoding="async">
            <div class="tpe-lens" id="tpeLens" aria-hidden="true" data-zoom="2,3×"></div>
          </div>
          <div class="tpe-caption"><small id="tpeCaptionKicker">ARAME TREFILADO</small><strong id="tpeCaptionTitle">Arame Trefilado · Baixo Carbono</strong></div>
        </div>
        <aside class="tpe-info">
          <span class="tpe-info-kicker" id="tpeInfoKicker">ARAME TREFILADO</span>
          <h3 id="tpeInfoTitle">Arame Trefilado · Baixo Carbono</h3>
          <p id="tpeInfoLead">Arame trefilado para aplicações industriais em que uniformidade dimensional, bitola e condição de fornecimento precisam ser avaliadas.</p>
          <div class="tpe-specs" id="tpeSpecs">
  ...
  <section class="th-section th-about" id="quem-somos">
    <div class="th-container th-about-grid">
      ...
      <figure class="th-about-image"><?php echo wp_get_attachment_image(54, 'medium_large', false, ['alt'=>'Ambiente industrial Torcisão','loading'=>'lazy','decoding'=>'async','sizes'=>'(max-width: 767px) 100vw, 50vw']); ?></figure>
    </div>
